...
class TestGDCMethods():
    ...
    def test_gdc(self, config, data_dir):
        ...
        args = Namespace(config=config, file=['f483ad78-b092-4d10-9afb-eccacec9d9dc'], manifest=None,output=data_dir,
                         repo='gdc')
        rc = icgc_download_client.call_client(args)
        ...
        assert (os.path.isfile(data_dir + 'f483ad78-b092-4d10-9afb-eccacec9d9dc/' +
                               'TCGA-CH-5763-01A-11D-1572-02_AC1JWAACXX' +
                               '---TCGA-CH-5763-11A-01D-1572-02_AC1JWAACXX---Segment.tsv') and
                file_info.st_size == 1483)
    ...
    def test_gdc_double(self, config, data_dir):
        ...
        assert (os.path.isfile(data_dir + '48016dd8-6033-4d73-8c85-f6eb1896e465/annotations.txt') and
                os.path.isfile(data_dir + '48016dd8-6033-4d73-8c85-f6eb1896e465/annotations.txt'))

    def test_gdc_manifest(self, config, data_dir):
        args = Namespace(config=config, file=None,
                         manifest='/Users/GavinWilson/git/icgc-download-client/test/' +
